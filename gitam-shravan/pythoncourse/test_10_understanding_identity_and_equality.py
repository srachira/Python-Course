...
-The Identity and equality differences.
-Two objects are identical if they are same objects.
-The behavior of "is" between -5 and 256.
-None a builtin function that can be used as x is None, instead of if x == None
"""
