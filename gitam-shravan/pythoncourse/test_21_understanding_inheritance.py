...
-Inheritance is a way to establish a relationship between objects or classes.
-Inheriting features of one class into another
-We can use __init__ to the base class if the derived class overrides it.
-Superclass can be used for overriding subclass methods. :) :)
"""
