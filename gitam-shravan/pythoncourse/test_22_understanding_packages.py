...
def test_package_basic_import():
    ...
    print package1.module1.__doc__ #Print None since module1 in package1 is empty
...
def test_package_import_failure():
    ...
    why_it_failed = "A directory containing __init__.py is treated as a package."
...
def test_package_sub_packages():
    ...
    #Since we imported sub package, sub package has __init__.py which
    # makes it a package and it has m1 in it.. So an exception is not raised:)
    print subpackage.m1.__doc__ #prints None since m1 sub module is empty

    assert True == ("package1.subpackage.m1" in sys.modules)

three_things_i_learnt = """
-Packages allows you to group related modules together,the relationship between packages
 and modules is similar to that of directories and files in the filesystem.
-__init__.py is necessary to define a package.
-A module with name a.b.c is saying that c is a module in package b which is a sub-package of module a.
-Modules need to be explicit we have to import generally.
"""
