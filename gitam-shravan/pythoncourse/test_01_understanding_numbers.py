...
-Ease of knowing about type of object using the Python Interpreter
-String types should always be single or double quoted while using it with assert care should be taken
-Understood the use of underscores after reading sir's post
-Understood the into integer conversion by mentioning number and it's corresponding base type
"""
