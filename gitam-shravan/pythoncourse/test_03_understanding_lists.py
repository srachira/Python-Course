...
-What is a list and lists are mutable unlike strings. Lists can have duplicates.
-Basic methods that can be performed on lists(sort,reverse,append,pop,insert,extend)
-A list can have lists within it,lists can have any type of value in them
-About the range in lists which can take 3 parameters 1st is the start 2nd stop and 3rd step,
the 1st parameter<2nd parameter. The 3rd parameter specifies increment or decrement.
"""
