...
-Scope of a variable globally and locally
-How the value of a variable changes in a function and how it behaves globally
-calling and changing the value of the global variable and using it within a function
and still that global variable is not local to the function, :)
"""
