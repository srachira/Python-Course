...
def test_dictionary_empty():
    ...
    assert empty_dict_1 == empty_dict_2 #True both have nothing in them
...
-Dictionaries are a pair of key,value counted as a single element
-Values are not indexed,Dictionaries are indexed by keys,Dictionaries are unordered.
-Searching is done by the key, Dictionaries are mutable. Add,Delete and modify operations can be performed on a dictionary!
-Dictionaries do not accept lists as their keys as lists are mutable
"""
