...
-Learnt about the control flow statements(similar to other languages)
-No other language can support else over loops.
-Loops are used for iterate over sequences.
-Learnt that Loops can support an else clause. :)
"""
