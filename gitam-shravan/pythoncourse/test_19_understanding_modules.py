...
in an interactive instance of the interpreter.These are modules!
-A module is a file containing Python definitions and statements and
saved as some_name.py.
-A module can contain executable statements as well as function definitions.
-There are 3 ways of importing a module..
1.import X
2.from X import*
3.from X import a, b, c  Where X is a module.
-When Python imports a module, it first checks the module registry
(sys.modules) to see if the module is already imported, if already imported
it uses the existing else it creates a new module,and then it inserts it in
