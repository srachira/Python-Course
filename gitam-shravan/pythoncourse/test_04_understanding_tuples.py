...
def test_tuple_unpacking():
    ...
    triplet = (10, 20, 30)
    try:
        a, b, c = triplet #Added c to change it to correct
        assert True # should not come here.
    except ValueError as ve: #When a,b=triple error value
        print ve  # observe what is printed here.
        # ve value is "too many values to unpack" as only a,b are given whereas triplet has 3 elements in it
        assert True
...
-Tuples are same as lists but values cannot be changed.Tuples can have duplicates
-Tuples are immutable,tuples can nest within other tuples(same as Lists)
-Syntax of single element tuple (element1,)
-Conversion of tuple into list, tuple into string and joining
"""
