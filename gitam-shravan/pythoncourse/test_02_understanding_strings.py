...
def test_string_concat():
    ...
    #Blank Space after both hello and before world so 2 spaces
    assert "Hello world" == """Hello """ + 'world'
    #Blank Space after hello so only 1 space
    assert "Hello world" == 'Hello ' + "world"
    #Blank Space after hello so only 1 space
...
def test_string_slicing():
    ...
    #It is starting to number specified and number specified to end


def test_string_repeat():
    assert 'HelloHelloHello' == "Hello" * 3
    assert 12 == len("Hello " * 2)
    #Space after hello before end of double quotes is also counted
...
def test_string_formatting():
    ...
    #The arguments in format here are given numbers starting from 0
...
-About the Double quotes and Triple quotes
-About the String Methods
-About String Formatting and Precedence
"""
