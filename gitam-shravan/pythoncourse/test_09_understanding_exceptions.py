...
def test_exception_flow_1():
    ...
    try:
        ...
        #The flow if broken and the exception error is checked!
        result.append("two")
...
def test_exception_flow_2():
    ...
    try:
        ...
        result.append("two")#Doesn't reach here since we encountered an error previously(division by 0)
...
-The usage of try and except block.
-Using else with except block and try block
-The runtime system always executes the statements within the finally
block regardless of what happens within the try and except block.
"""
