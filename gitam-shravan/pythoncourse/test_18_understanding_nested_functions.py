...
-Nested functions are functions within functions but the scope within them has to be considered
-Scope of the variable should be kept in mind while working with nested functions
-Passing values to a nested function using "()()"
-Scope rules apply same to a function and a variable. :)
"""
